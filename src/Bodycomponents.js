...
<div
  data-cy="tertiaryRowHeaderContainer"
  className="choosFrom__header snipcss-MLU2k"
>
  <img
  ...
  />
        ...
        <div className="choosFrom__wrap snipcss-WnrFX">
  <ul data-cy="tertiaryRowItemsContainer" className="choosFrom__list">
    ...
    <li className="choosFrom__list--item" data-cy="tertiaryRowItem_Gift Cards">
