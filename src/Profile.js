...
useEffect(()=>{
axios.post('https://backend-mmt.onrender.com/profileView',{email:"venusubash.r@codingmart.com"}).then((res)=>{console.log(res)
...
setmarriage(res.data.matitalStatus);
  ...
  function senddetails(e) {
    // e.preventDefault();
    axios.post('https://backend-mmt.onrender.com/profileEdit', { email: 'venusubash.r@codingmart.com', name: name, gender: gender, matitalStatus: marriage, address: address, pincode: pincode, state: state }).then((res) => { console.log(res) }).catch((err) => console.log(err))
    setforamflag(false)
  ...
  return (
    <div style={{ display: 'flex' }}>
      <div className="profilSdeBar profilSdeBar--sticky snipcss-J9Ioo" style={{ backgroundColor: 'white', width: '300px', height: '400px', alignContent: 'center', alignItems: 'center', alignSelf: 'center' }}>

        <div onClick={handleClick} style={{ cursor: "pointer", marginLeft: '50px', marginTop: '-60px' }}>
          {image ? (
            <img src={URL.createObjectURL(image)} alt="upload image" className="img-display-after" style={{ borderRadius: '100%', height: '150px,', marginLeft: '30px', marginTop: '40px' }} />
          ) : (
        ...
        <div className="profilSdeBar__contntWrap" style={{ marginTop: '10px' }}>
          <p className="font20 latoBlack blackText">Venusubash</p>
      ...
      {formflag &&
        <div className="profilEdtFomCrd snipcss-tVrEm">
          ...
          <form data-cy="profileEditFormCard_O2">
            ...
            <div className="profilEdtFomCrd__footer">
              <span
